 ...
 */
public class WWDetailsFragment extends Fragment {
    ...
    // LOGGING VARIABLES
    private static final String TAG = WWDetailsFragment.class.getSimpleName(); // Retrieves the simple name of the class.
    ...
    private final static WWDetailsFragment details_fragment = new WWDetailsFragment();

    // WWDetailsFragment(): Deconstructor for the WWDetailsFragment.
    public WWDetailsFragment() {}

    // getInstance(): Returns the details_fragment instance.
    public static WWDetailsFragment getInstance() { return details_fragment; }
